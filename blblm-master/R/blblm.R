...
#' @export
blblm <- function(formula, data, m = 10, B = 5000, cpu = 1) {
  ...
  estimates <- map(
    data_list,
    ~ lm_each_subsample(formula = formula, data = ., n = nrow(data), B = B, cpu = cpu))
...
#' a function to split dataframe
#' @param data name of dataset
#' @param m split to m parts
...
#' @param formula object of formula ex. x~y
#' @param data name of dataset
#' @param n sample size
...
#' @param formula object of "formula" class
#' @param data a data set
#' @param freqs frequecy values
